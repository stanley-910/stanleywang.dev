...
<TOC title="Exploring the Intersection of Design, AI, and Design Engineering" />
...
### Whatever Whatever code

`code fu1la.,;{}`

No table support yet [^1]

[^1]: Notei

[AI](https://github.com/stanley-utf8) is ==no== longer just a backend tool—it's becoming an active collaborator in the creative process. From generating design ideas to optimizing layouts, AI offers endless possibilities. For instance
...
- Automation**Automation Repetitive**: Repetitive tasks like resizing assets or formatting layouts can be automated, freeing up designers for more strategic work.
...
<Cover src="/trading-fours1.png" title="Ethical Design" alt="asdw" caption="reinforce biases." />
...
<StarDivider variant={1} className="fill-zinc-900 dark:fill-red-400 transition-colors" />
<StarDivider  variant={1} className="fill-zinc-900 dark:fill-blue-400 transition-colors" />
...
> "Good design is as little design as possible." — Dieter Rams esign is as little design as possible." — Dieter Ramsesign is as little design as possible." — Dieter Rams
>
> Also I fucked ya bitch
